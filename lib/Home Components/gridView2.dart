...
class _ViewAllState extends State<ViewAll2> with SingleTickerProviderStateMixin {
  final List items;
                            ...
                            child: Stack(
                              children: [
                                ...
                                Image.network(
                                  ...
                                  isLanguage
                                      ? temp[index]["thumbnail_link"]
                                      : temp[index]["thumbnail"].toString() ==
                                              "null"
                                          ? temp[index]["singer_image"]
                                              .toString()
                                          : temp[index]["thumbnail"].toString(),
                                  fit: BoxFit.cover,
                                ...
                                items[index]["amount"] != "0"
                                    ? Container(
                                        ...
                                        height: 25,
                                        width: 25,
                                        child: Image.asset(isActors == true ||
                                                isLanguage == true
                                            ? ""
