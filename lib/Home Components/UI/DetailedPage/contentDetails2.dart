...
class ContentDetails2 extends StatefulWidget {
  ContentDetails2(this.item);

  final DataChild item;
...
class _ContentDetailsState extends State<ContentDetails2>
