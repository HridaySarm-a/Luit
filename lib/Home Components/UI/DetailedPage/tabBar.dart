...
class _ContentPageTabBarState extends State<ContentPageTabBar>
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: TabBarView(
                    controller: _tabController,
                    children: <Widget>[moreLikeThis(), moreInfo()],
                  ),
                ),
              ),
            ],
                            ...
                            child: InkWell(
                              child: Stack(children: [
                                SizedBox(
                                  ...
                                  height: 160,
                                  child: Image.network(
                                      moreLikeThisList[position]["thumbnail"]
                                          .toString(),
      ...
      child: Padding(
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            item["type"] == "music" && item["choreographer"].length != 0
                ? choregrapher()
                : SizedBox.shrink(),
            item["type"] == "music" && item["choreographer"].length != 0
                ? Divider(
                ...
                : SizedBox.shrink(),
            item["type"] == "music" && item["musicDirectors"].length != 0
                ? musicDirectors()
                : SizedBox.shrink(),
            item["type"] == "music" && item["musicDirectors"].length != 0
                ? Divider(
                ...
                : SizedBox.shrink(),
            item["type"] == "music" && item["singers"].length != 0
                ? singer()
                : SizedBox.shrink(),
            item["type"] == "music" && item["singers"].length != 0
                ? Divider(
