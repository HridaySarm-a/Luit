...
class TermsAndConditions extends StatelessWidget
{
			...
			(
				...
				(
					...
					(
						...
						'iii. You shall be held responsible for any losses incurred by the Company or any third party user due to unauthorized use of Your Account which is a consequence of the Users inability to secure his / her Account.'  +'\n\n'+
	...
	Widget appBar()
	{
    	return AppBar
		(
      		title: Text("Terms and Conditions", style: TextStyle(fontSize: 16.0),),
      		centerTitle: true,
