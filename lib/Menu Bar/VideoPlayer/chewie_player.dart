...
import 'package:luit/Menu%20Bar/VideoPlayer/player_with_controls.dart';
...
{
  const Chewie(this.item, {Key key, this.controller,})  : assert(controller != null, 'You must provide a chewie controller'),
        super(key: key);
  ...
  ChewieState createState() {
    return ChewieState(this.item);
  }
}

class ChewieState extends State<Chewie> {

	ChewieState(this.item);
	final item;
