...
import 'package:luit/Menu%20Bar/VideoPlayer/cupertino_controls.dart';
import 'package:luit/Menu%20Bar/VideoPlayer/material_controls.dart';
import 'package:video_player/video_player.dart';

class PlayerWithControls extends StatelessWidget 
{
	PlayerWithControls(this.item, {Key key}) : super(key: key);
	...
	Widget build(BuildContext context) 
	{
		...
		{
			final controls = Theme.of(context).platform == TargetPlatform.android ?  MaterialControls(item) : const CupertinoControls(backgroundColor: Color.fromRGBO(41, 41, 41, 0.7),iconColor: Color.fromARGB(255, 200, 200, 200),);
